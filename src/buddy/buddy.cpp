...
extern const volatile int BUDDY_PIN     = 26;
extern const volatile int MIN_PULSE_LEN = 600;
extern const volatile int MAX_PULSE_LEN = 1600;
extern const volatile int MAX_TDIFF     = MAX_PULSE_LEN * (1 + 0.1);
extern const int MAX_CHANNELS           = 32;
extern const volatile int MAX_CHANNELS_LESS_ONE = MAX_CHANNELS - 1;
